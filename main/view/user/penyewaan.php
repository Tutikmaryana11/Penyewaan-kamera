<?php include_once 'template/menu/menu_user.php'; ?>
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><i class="fa fa-th-list">&nbsp;</i>Penyewaan <a href="index.php?view=penyewaan_view_add_user"><span class="fa fa-plus-circle"></span></a></h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
						...
						<table width="100%" class="table table-striped table-bordered table-hover" id="example">
							...
							<tbody>
								<tr>
									...
									where s.sewa_id_user = $_SESSION[user_id] ";
									$b = mysql_query($a);
									$no =1;
									...
									while($c = mysql_fetch_array($b)){
										...
										<td>
											<?php if ($c['bayar_status'] == null) { ?>
												<a href="index.php?view=penyewaan_detail_user&id_sewa=<?php echo $c['sewa_id']?>&edit=true"><b>#<?php echo $c['sewa_invoice'];?></b></a>
											<?php } else { ?>
												<a href="index.php?view=penyewaan_detail_user&id_sewa=<?php echo $c['sewa_id']?>&edit=false"><b>#<?php echo $c['sewa_invoice'];?></b></a>
											<?php } ?>
										</td>
