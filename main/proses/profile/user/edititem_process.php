...
if ($password != $password2) {
	...
	echo "<script>document.location.href='index.php?view=profile&status=failInsert';</script>";
}
...
elseif ($password =='d41d8cd98f00b204e9800998ecf8427e') {
	...
	if ($qry2) {
		echo "<script>document.location.href='index.php?view=profile&status=success';</script>";
	}
	else {
		echo "<script>document.location.href='index.php?view=profile&status=failInsert';</script>";
	}
